"""
Django settings for aqss_379 project.
...
WSGI_APPLICATION = 'aqss_379.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aqss_379 API",
    "DESCRIPTION": "API documentation for aqss_379 App",
    "VERSION": "v1",
}
